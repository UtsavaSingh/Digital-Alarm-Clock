...
void main(void) {
    ...
    unsigned char control_flag = 0x05, reset_flag = 0x13;
    ...
    while (1) {
        ...
        key_level = read_digital_keypad(0);

        if((control_flag == 0x01) && (key == 0x37 || key == 0x2F))
        {
        ...
        else if((control_flag == 0x02) && (key_level == 0x37) && (delay1++ == 20))
        {
        ...
        else if((control_flag == 0x03) && (key_level == 0x37) && (delay2++ == 20))
        {
        ...
        else if((control_flag == 0x04) && (key_level == 0x37) && (delay3++ == 20))
        {
        ...
        else if((control_flag == 0x02) && (key_level == 0x2F) && (delay4++ == 20))
        {
        ...
        else if((control_flag == 0x03) && (key_level == 0x2F) && (delay5++ == 20))
        {
        ...
        else if((control_flag == 0x04) && (key_level == 0x2F) && (delay6++ == 20))
        {
        ...
        else if((control_flag == 0x07) && (key_level == 0x2F) && (delay1++ == 20))
        {
            ...
            write_ds1307(0x00, dec2bcd(second));
            write_ds1307(0x01, dec2bcd(minute));
            write_ds1307(0x02, dec2bcd(hour));
            clear_screen();
        }
        else if((control_flag == 0x08) && (key_level == 0x2F) && (delay2++ == 20))
        {
            ...
            write_ds1307(0x06, dec2bcd(year));
            write_ds1307(0x05, dec2bcd(month));
            write_ds1307(0x04, dec2bcd(day));
            clear_screen();
        }
        else if((control_flag == 0x05) && (key_level == 0x2F) && (delay3++ == 20))
        {
        ...
        else if((control_flag == 0x06) && (key_level == 0x2F) && (delay1++ == 20))
        {
        ...
        switch(control_flag)
        {
            ...
            case 0x06 :
            {
                ...
                TMR2ON = 1;
                if(display_event(reset_flag) == 0x22)
                {
                    control_flag = 0x02;
                    reset_flag = 0x10;
                    clear_screen();

...
# 1 "./digital_alarm_clock.h" 1
# 11 "./digital_alarm_clock.h"
...
void get_date(void)
{
    date_reg[0] = read_ds1307(0x04);
    date_reg[1] = read_ds1307(0x05);
    date_reg[2] = read_ds1307(0x06);
    date_reg[3] = read_ds1307(0x03);
}
...
void display_dash_screen(unsigned char reset_flag)
{
    ...
    if(event)
    {
        ...
        if(sec)
        {
            ...
            clcd_print(time, (0x80 + 6));
            clcd_print("EVENT ", (0xC0 + 0));

            clcd_print(new_event, (0xC0 + 6));
        }
        else
        {
            clcd_print("DATE  ", (0x80 + 0));

            clcd_print(date, (0x80 + 6));
            clcd_print("TIME  ", (0xC0 + 0));

            clcd_print(time, (0xC0 + 6));
            clcd_putch(' ', (0xC0 + 15));
        }
    }
    else
...
unsigned char menu1(unsigned char reset_flag, unsigned char key)
{
    ...
    if(menu_pos == 0)
    {
        clcd_putch(0x3E, (0x80 + 0));
        clcd_putch(' ', (0xC0 + 0));
    }
    else if(menu_pos == 1)
    {
        clcd_putch(' ', (0x80 + 0));
        clcd_putch(0x3E, (0xC0 + 0));
    }
    clcd_print(menu_1[0], (0x80 + 2));
    clcd_print(menu_1[1], (0xC0 + 2));
    return menu_pos;
}
...
unsigned char menu2(unsigned char reset_flag, unsigned char key)
{
    ...
    clcd_print(menu_2[0], (0x80 + 2));
    clcd_print(menu_2[1], (0xC0 + 2));
    return menu_pos;
}
...
unsigned char menu3(unsigned char reset_flag, unsigned char key)
{
    ...
    clcd_print(menu_3[0], (0x80 + 2));
    clcd_print(menu_3[1], (0xC0 + 2));
    return menu_pos;
}
...
void set_time(unsigned char reset_flag, unsigned char key)
{
    ...
    if(reset_flag == 0x14)
    {
        ...
        clcd_putch(time[0], (0xC0 + 4));
        clcd_putch(time[1], (0xC0 + 5));
        clcd_putch(':', (0xC0 + 6));
        clcd_putch(time[2], (0xC0 + 7));
        clcd_putch(time[3], (0xC0 + 8));
        clcd_putch(':', (0xC0 + 9));
    ...
    clcd_putch(new_time[0], (0xC0 + 4));
    clcd_putch(new_time[1], (0xC0 + 5));
    clcd_putch(':', (0xC0 + 6));
    clcd_putch(new_time[2], (0xC0 + 7));
    clcd_putch(new_time[3], (0xC0 + 8));
    clcd_putch(':', (0xC0 + 9));
    clcd_putch(new_time[4], (0xC0 + 10));
    clcd_putch(new_time[5], (0xC0 + 11));
...
void set_date(unsigned char reset_flag, unsigned char key)
{
    ...
    if(reset_flag == 0x16)
    {
        ...
        clcd_putch(date[0], (0xC0 + 4));
        clcd_putch(date[1], (0xC0 + 5));
        clcd_putch('-', (0xC0 + 6));
        clcd_putch(date[2], (0xC0 + 7));
        clcd_putch(date[3], (0xC0 + 8));
        clcd_putch('-', (0xC0 + 9));
        clcd_putch(date[4], (0xC0 + 10));
        clcd_putch(date[5], (0xC0 + 11));
    ...
    clcd_putch(new_date[0], (0xC0 + 4));
    clcd_putch(new_date[1], (0xC0 + 5));
    clcd_putch('-', (0xC0 + 6));
    clcd_putch(new_date[2], (0xC0 + 7));
    clcd_putch(new_date[3], (0xC0 + 8));
    clcd_putch('-', (0xC0 + 9));
    clcd_putch(new_date[4], (0xC0 + 10));
    clcd_putch(new_date[5], (0xC0 + 11));
...
void set_event(unsigned char reset_flag, unsigned char key)
{
    ...
    if(am_pm_flag)
    {
        if(flag)
        {
            ...
            clcd_putch(new_event[4], (0x80 + 12));
            clcd_putch(new_event[5], (0x80 + 13));
        }
        else
        {
            clcd_putch(' ', (0x80 + 12));
    ...
    if(minute_flag)
    {
        if(flag)
        {
            ...
            clcd_putch(new_event[2], (0x80 + 9));
            clcd_putch(new_event[3], (0x80 + 10));
        }
        else
        {
            clcd_putch(' ', (0x80 + 9));
    ...
    if(hour_flag)
    {
        if(flag)
        {
            ...
            clcd_putch(new_event[0], (0x80 + 6));
            clcd_putch(new_event[1], (0x80 + 7));
        }
        else
        {
            clcd_putch(' ', (0x80 + 6));
    ...
    if(duration_flag)
    {
        if(flag)
        {
            ...
            clcd_putch(new_event[6], (0xC0 + 9));
            clcd_putch(new_event[7], (0xC0 + 10));
        }
        else
        {
            clcd_putch(' ', (0xC0 + 9));
    ...
    if(times_flag)
    {
        ...
        {
            new_event[8] = times[i];
            clcd_putch(new_event[8], (0xC0 + 15));
        }
        else
        {
            clcd_putch(' ', (0xC0 + 15));
    ...
    clcd_putch(':', (0x80 + 8));
    clcd_putch(' ', (0x80 + 11));
    clcd_putch(0x2F, (0x80 + 15));
    clcd_putch('0', (0xC0 + 6));
    clcd_putch('0', (0xC0 + 7));
    clcd_putch(':', (0xC0 + 8));
    clcd_putch(':', (0xC0 + 11));
    clcd_putch('0', (0xC0 + 12));
    clcd_putch('0', (0xC0 + 13));
...
unsigned char display_event(unsigned char reset_flag)
{
    if(reset_flag == 0x15)
    {
        ...
        clear_screen();
        clcd_print("# T - ", (0x80 + 0));
        clcd_print("0 D - ", (0xC0 + 0));
        clcd_putch(read_EEPROM(0x01), (0x80 + 6));
        clcd_putch(read_EEPROM(0x02), (0x80 + 7));
        clcd_putch(':', (0x80 + 8));
        clcd_putch(read_EEPROM(0x03), (0x80 + 9));
        clcd_putch(read_EEPROM(0x04), (0x80 + 10));
        clcd_putch(' ', (0x80 + 11));
        clcd_putch(read_EEPROM(0x05), (0x80 + 12));
        clcd_putch(read_EEPROM(0x06), (0x80 + 13));
        clcd_putch('/', (0x80 + 15));

        clcd_putch('0', (0xC0 + 6));
        clcd_putch('0', (0xC0 + 7));
        clcd_putch(':', (0xC0 + 8));
        clcd_putch(read_EEPROM(0x07), (0xC0 + 9));
        clcd_putch(read_EEPROM(0x08), (0xC0 + 10));
        clcd_putch(':', (0xC0 + 11));
        clcd_putch('0', (0xC0 + 12));
        clcd_putch('0', (0xC0 + 13));
        clcd_putch(read_EEPROM(0x09), (0xC0 + 15));
    }
